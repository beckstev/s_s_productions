...
unkontrollierbaren Umweltfaktoren wie z.\, B. Staub ab. %entweder von...ab oder mit...zusammen
So wurden die Messungen, auf Grund von Bauarbeiten in einem Nachbarraum, %präsenz
...
bei den Messungen werden jedoch lediglich ein Maximum von $I_{p}^{max}=\SI{0.76}{\milli\ampere}$ %präsenz
...
%vielleicht noch ungleiche amplituden bei T10 diskutieren
