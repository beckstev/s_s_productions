...
Durch die Bedingung \eqref{eq: longmoden} tritt eine durch durch die Anordnung gegebene Selektion der möglichen Wellenlängen auf. Innerhalb
...
Als Resonatormedium wird bei \ce{HeNe}-Laser ein Gemisch aus einem Teil Helium und fünf Teilen Neon verwendet, das unter einem Druck von
...
des $5s$-Niveaus pro Zeiteinheit wahrscheinlicher als spontane Emission\footnote{Das eingans beschriebene Zwei-Niveau-System kann eine solche
