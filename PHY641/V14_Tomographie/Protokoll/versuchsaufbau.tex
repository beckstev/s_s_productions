...
einem komplett leeren Würfel statt. Mit der Leermessung wird die Größe $N_0$ bestimmt. %wir messen counts, nicht intensitäten
...
Die Analyse eines Würfels erfolgt in zwölf einzelnen Messungen $i$. %einzelnen, punkt
...
Bei jeder der zwölf Messungen wird die Ausrichtung des Würfels zum $\gamma$-Strahl geändert.%satzbau
...
\begin{figure}[h]
  ...
  \caption{Verschiedenen Positionierunngen des Würfels. \cite{luckyjosh}.} %n
...
wird an einem \emph{Diskriminator} weitergeleitet, der dieses je nach Signalstärke, einen Channel des %einem
\emph{Multichannelanalyzers} zuweist. Der Multichannelanalyzer zählt, wie oft ein Signal einem Channel (insgesamt 1024) zugewiesen wurde, und %analyzers
...
gezählten Photonen aufgetragen. %Photonen, zählt nicht anzahl photonen
Zu den Wechselwirkungseffekten gehören \emph{Compton Streuung}, \emph{Photoeffekt} und die \emph{Paarerzeugung}. %ohne zum einen
...
Die Compton Streuung sorgt für eine Energieabschwächung der $\gamma$-Strahlung und ist deshalb für die Counts links von dem %links
