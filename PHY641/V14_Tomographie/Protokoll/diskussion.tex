...
Würfel in der Mitte (Würfel 5) aus Blei besteht, während die umliegenden signifikant dem Wert %signifikant eher klingt nicht so gut
...
bzw. $\SI{0.4}{\centi\meter^{-1}}$ zu Blei keine sichere Aussage möglich. Das numerische Verfahren liefert einen unphysikalischen %nicht wieder signifikant verwenden
negativen Wert für Würfel 9. Dies ist auf die bereis genannten Fehlerquellen zurückzuführen. % zurückzuführen, also zusammen geschrieben
